...
import { setFocusMode, useUIStore } from '../../../store/ui';
import { Button, Kbd } from '../../../ui';
import './focus.css';

export const toggleFocusMode = () => setFocusMode(!useUIStore.getState().focusMode);
...
/** ⌘. toggles focus mode and Escape leaves it; styles read `html[data-focus-mode]` to step the chrome back. */
...
export function FocusExit() {
  return (
    <Button size="sm" variant="ghost" leadingIcon={Minimize2} onClick={() => setFocusMode(false)} className="focus-exit no-drag ml-auto">
      Exit focus
