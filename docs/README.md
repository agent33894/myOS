...
- [`product-model.md`](product-model.md): what myOS Next is, what you work with, and how it reads
- [`plan.md`](plan.md): the build plan and the contracts Wave B builds on
- [`architecture-overview.md`](architecture-overview.md): processes, modules, and data flow
